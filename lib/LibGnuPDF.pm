...
module LibGnuPDF {
    ...
    our sub pdf_status_destroy(OpaquePointer) is export(:subs, :DEFAULT) is native(&find-lib) { * }
    my constant pdf_status_t is export(:types, :DEFAULT) = OpaquePointer but PdfAlloced[&pdf_status_destroy];
